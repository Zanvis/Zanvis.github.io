...
@Component({
  selector: 'app-core',
  standalone: true,
  imports: [CommonModule, HammerModule, VgCoreModule, VgControlsModule, VgOverlayPlayModule, VgBufferingModule, TranslateModule],
